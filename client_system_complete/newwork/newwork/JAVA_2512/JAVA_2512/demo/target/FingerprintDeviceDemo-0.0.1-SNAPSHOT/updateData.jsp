		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="sync-card">
					...
					<div class="sync-subtitle">Selected date ke basis par direct online-device sync. Status ke liye UPD_DATE aur delete ke liye DEL_DATE use hoga. Offline devices ke liye koi DEVICECMD queue create nahi hogi.</div>
